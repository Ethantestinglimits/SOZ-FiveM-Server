export enum RpcServerEvent {
    ...
    VEHICLE_TRUNK_GET_OCCUPIED = 'soz-core:server:vehicle:trunk-get-occupied',
    ...
    PHONE_DEVICE_SAVE_SETTINGS = 'soz-core:server:phone:device:save-settings',
    PHONE_DEVICE_SETUP = 'soz-core:server:phone:device:setup',
    PHONE_DEVICE_UNLOCK = 'soz-core:server:phone:device:unlock',
