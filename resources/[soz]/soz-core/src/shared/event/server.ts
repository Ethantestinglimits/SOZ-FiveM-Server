export enum ServerEvent {
    ...
    VEHICLE_CHECK_GLOVEBOX_EXPLOSIVE = 'soz-core:server:vehicle:check-glovebox-explosive',
    ...
    POLICE_VEHICLE_EXPLOSIVE_DETONATION = 'soz-core:server:police:vehicle-explosive-detonation',
