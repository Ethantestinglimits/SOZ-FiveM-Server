export enum NuiEvent {
    ...
    PlayerMenuDuoAnimationRequest = 'soz-core:nui:player:menu:duo-animation-request',
    ...
    PhoneDeviceSaveSettings = 'soz-core:nui:phone:device:save-settings',
    PhoneDeviceSetup = 'soz-core:nui:phone:device:setup',
    PhoneDeviceUnlock = 'soz-core:nui:phone:device:unlock',
